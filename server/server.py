...
from tools.general_tools import validate_ip_port, parse_command_for_server, CustomValidationException
...
class RequestHandler(StreamRequestHandler):
    ...
    def handle(self):
        while True:
            ...
            result = self.server.process_command(self.client_address, str(payload, 'utf-8'))
...
class KeyValueServer(TCPServer):
    ...
    def __init__(self, server_address: Tuple[str, int]):
        ...
        super().__init__(server_address=server_address, RequestHandlerClass=RequestHandler)
